...
public class Editor extends javax.swing.JPanel {
    ...
    NumeroLinea numeroLinea;
     public Editor(String nombre, File documento) {
         this.nombre= nombre;
    ...
    public Editor(String texto, boolean editable) {
        initComponents();
        numeroLinea = new NumeroLinea(AreaTexto);
        scrollPane.setRowHeaderView(numeroLinea);
        llenarTextoSiEdicion(texto);
    ...
    private void llenarTextoSiEdicion(String Texto){
        AreaTexto.setText(Texto);
